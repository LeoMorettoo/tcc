...
class TreesControllerTest < ActionController::TestCase
  ...
  test "should create tree" do
    assert_difference('Tree.count') do
      post :create, tree: { instances_numbers: @tree.instances_numbers, name: @tree.name, tree_size: @tree.tree_size, user_id: @tree.user_id, variable_numbers: @tree.variable_numbers }
    end
  ...
  test "should update tree" do
    patch :update, id: @tree, tree: { instances_numbers: @tree.instances_numbers, name: @tree.name, tree_size: @tree.tree_size, user_id: @tree.user_id, variable_numbers: @tree.variable_numbers }
    assert_redirected_to tree_path(assigns(:tree))
  end
